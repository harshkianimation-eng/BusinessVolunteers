      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <div className="bg-dark/50 p-6 rounded-2xl border border-light/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 w-full">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="w-full">
                <label htmlFor="email" className="block text-light mb-2 text-sm sm:text-base">
                  Email
                </label>
                <input
                  type="email"
            ...
            <div className="w-full">
              <label htmlFor="subject" className="block text-light mb-2 text-sm sm:text-base">
                Subject
              </label>
              <input
                type="text"
            ...
            <div className="w-full">
              <label htmlFor="message" className="block text-light mb-2 text-sm sm:text-base">
                Message
              </label>
              <textarea
                id="message"
            ...
            <button
              type="submit"
              className="w-full bg-primary text-dark py-4 rounded-xl font-semibold text-base sm:text-lg flex items-center justify-center gap-3"
            >
              Send Message
              <Send size={20} />
            </button>
